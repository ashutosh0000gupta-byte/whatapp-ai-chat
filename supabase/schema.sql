-- ================================================================
--  WhatsApp CRM AI — Supabase Schema (Restaurant Edition)
...
CREATE TABLE IF NOT EXISTS customers (
  ...
  phone         TEXT UNIQUE NOT NULL,          -- WhatsApp phone e.g. +919876543210
  name          TEXT,
...
-- Dashboard users will use the anon key with RLS policies (add as needed).
